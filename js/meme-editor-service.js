...
function gImgsDefault() {
    return [
        ...
        createImgTemplate('imgs/10.jpg', 'pointing old do what would Haim Hacat haim hacat'),
        createImgTemplate('imgs/11.jpg', 'what are you doing jersey shore douchbag stupid why do come on'),
        ...
        createImgTemplate('imgs/14.jpg', 'african children young dancing starving funny hahaha in your face baby'),
        ...
        createImgTemplate('imgs/20.jpg', 'leo leonardo di caprio great gatsby cheers congrats congratulations toast to you'),
        createImgTemplate('imgs/21.jpg', 'lawrence fishburne matrix neo what if told you i revelation'),
        createImgTemplate('imgs/22.jpg', 'lotr Lord of the Rings one does not simply walk into mordor'),
        createImgTemplate('imgs/23.jpg', 'oprah winfrey you get a car show the talkshow excited ecstatic'),
        createImgTemplate('imgs/24.jpg', 'captain kirk picard star trek oh snap you you\'re in trouble screwed comeback'),
        createImgTemplate('imgs/25.jpg', 'putin president russia manly man bearkiller world leader you are in trouble you\'re'),
